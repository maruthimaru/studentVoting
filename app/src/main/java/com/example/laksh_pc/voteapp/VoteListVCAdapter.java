...
public class VoteListVCAdapter extends RecyclerView.Adapter<VoteListVCAdapter.StudentModel> {
    ...
    public VoteListVCAdapter(Context context, List<UserModel> BusListModelList, ItemListener listener) {
